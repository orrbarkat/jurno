...
(function() {
  var shrLoccLoader = setInterval(function() {
    if (document.body) {
      var locc_pixel = document.createElement("img");
      locc_pixel.src = document.location.protocol + "//bcp.crwdcntrl.net/map/c=9193/tp=SHLC/tpid=45bd4b4c-f762-4fdc-9e64-23c7f05637be";
      locc_pixel.style.height = "1";
      locc_pixel.style.width = "1";
      locc_pixel.style.border = "0";
      locc_pixel.style.display = "none";
      document.body.appendChild(locc_pixel);
      clearInterval(shrLoccLoader);
    }
  }, 20);
}());
...
(function() {
    ...
    locc_human.src = document.location.protocol + '//n-cdn.areyouahuman.com/play/YNMJrK4lsMAJlxSsJDb17LW8YmmHRLakZxkWagp6?AYAH_F2=journohq.com&AYAH_P2=45bd4b4c-f762-4fdc-9e64-23c7f05637be&AYAH_F1=Lotame';
